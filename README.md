...
- Eslint
- Prettier
- Emmet (already in VS Code)

## VS Code Key Shortcut
- **Select line** > shift
- **Select all above/below** > shift + cmd + up/down
- **Shift** > option + up/down
- **Delete** > cmd + shift + k
- **Copy** > option + shift + up/down
- **Multi-cursor** > cmd + shift + l
- **Manual Muti-cursor** > cmd + d (select) || cmd + k (unselect)
- **After regex search** > option + enter (to select all matched) -> then option left/right (to edit)
- **Select word -> then cmd + option + f** = immediately search that word
